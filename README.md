...
|[MultiObjectTrackingVideoFile](https://github.com/DeGirum/PySDKExamples/blob/main/MultiObjectTrackingVideoFile.ipynb)|This demo measures vehicle traffic from video. Since I built it for non-real-time, I use cloud-inference, but if you want to use it for real-time, you can change to on-device inference as well.|
