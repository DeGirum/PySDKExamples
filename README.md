...
|[rtsp smart camera](https://colab.research.google.com/github/DeGirum/PySDKExamples/blob/main/examples/dgstreams/rtsp_smart_camera.ipynb)|How to stream AI annotated video with RTSP protocol.|
