...
class PostProcessor:
    def __init__( self ,json_config):
        ...
        self._maximum_detections = int(self._json_config["POST_PROCESS"][0]["MaxDetections"])
    ...
    def forward(self, tensor_list, details_list):
        ...
        preds = self.non_max_suppression(pred_order,conf_thres=self._output_conf_threshold,iou_thres = self._output_nms_threshold,agnostic=False,max_det=self._maximum_detections,classes=None,nc=1)
        for pred in preds:
