...
map_evaluator = ObjectDetectionModelEvaluator.init_from_yaml(model, 'benchmark_scripts/eval_yaml/coco.yaml')
...
map_results = map_evaluator.evaluate(img_folder_path, ground_truth_annotations_path = anno_json, num_val_images = 0, print_frequency = 100)
